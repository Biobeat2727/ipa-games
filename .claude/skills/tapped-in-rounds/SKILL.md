...
4. **Difficulty ladder.** Within each category, difficulty must rise with point value. Round 1 = broad recall a general bar crowd can play; Round 2 = harder, wordplay- and deduction-friendly; Round 3 = the hardest board of the night — every team should still get the 300s, the 1500s separate the winner. Double Tap wagers can reach 500 / 2000 / 3000 in rounds 1 / 2 / 3 (the Round 3 floor is a working assumption until Davey sets one), so a Round 3 board is where the leaderboard flips: keep the top values genuinely hard, not obscure.
